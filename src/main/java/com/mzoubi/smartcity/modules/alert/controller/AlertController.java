...
public class AlertController {
    ...
    public ResponseEntity<ApiResponse<Page<AlertDto>>> getAllAlerts(
        ...
        Page<AlertDto> alerts = alertService.getAllAlerts(pageRequest);
    ...
    @GetMapping("/{cityId}")
    public ResponseEntity<ApiResponse<Page<AlertDto>>> getAlertsByCity(
        ...
        PageRequest pageRequest = PaginationUtils.createPageRequest(
                pageNumber, pageSize, sortBy, sortDirection, ALLOWED_FIELDS);
        Page<AlertDto> alerts = alertService.getAlertsByCity(cityId, pageRequest);
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.success(
    ...
    @GetMapping("/resolved")
    public ResponseEntity<ApiResponse<Page<AlertDto>>> getResolvedAlerts(
            @PathVariable Long cityId,
            @RequestParam(value = "page-size", required = false) final Integer pageSize,
            @RequestParam(value = "page-number", required = false) final Integer pageNumber,
            @RequestParam(value = "sort-by", required = false) String sortBy,
        ...
        PageRequest pageRequest = PaginationUtils.createPageRequest(
                pageNumber, pageSize, sortBy, sortDirection, ALLOWED_FIELDS);
        Page<AlertDto> alerts = alertService.getResolvedAlerts(pageRequest);
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.success(
    ...
    @GetMapping("/active")
    public ResponseEntity<ApiResponse<Page<AlertDto>>> getActiveAlerts(
            @PathVariable Long cityId,
            @RequestParam(value = "page-size", required = false) final Integer pageSize,
            @RequestParam(value = "page-number", required = false) final Integer pageNumber,
            @RequestParam(value = "sort-by", required = false) String sortBy,
        ...
        PageRequest pageRequest = PaginationUtils.createPageRequest(
                pageNumber, pageSize, sortBy, sortDirection, ALLOWED_FIELDS);
        Page<AlertDto> alerts = alertService.getActiveAlerts(pageRequest);
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.success(
